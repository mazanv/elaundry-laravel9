                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-xl-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" name="nama_kurir" id="nama_kurir" class="form-control @error('nama_kurir') is-invalid @enderror" placeholder="Nama Kurir" value = "{{ $kurir->nama_kurir }}">
                                                @error('nama_kurir')
                                    ...
                                    <div class="col-lg-4 col-xl-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="email" name="email" id="email-id-icon" class="form-control  @error('email') is-invalid @enderror" placeholder="Email Kurir" value = "{{ $kurir->email }}">
                                                @error('email')
                                                  <span class="invalid-feedback text-danger" role="alert">
                                                      <strong>{{ $message }}</strong>
                                                  </span>
                                    ...
                                    <div class="col-lg-4 col-xl-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" name="no_telp" id="no_telp" class="form-control  @error('no_telp') is-invalid @enderror" placeholder="No. Telp Kurir" value = "{{ $kurir->no_telp }}">
                                                @error('no_telp')
                                                  <span class="invalid-feedback text-danger" role="alert">
                                                      <strong>{{ $message }}</strong>
                                                  </span>
                                    ...
                                    <div class="col-lg-5 col-xl-5 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                               <textarea type="text" name="alamat_kurir" class="form-control @error('alamat_kurir') is-invalid @enderror" value = "{{ $kurir->alamat }}" id="alamat_kurir" rows="3"></textarea>
                                               @error('alamat_kurir')
                                                  <span class="invalid-feedback text-danger" role="alert">
                                                      <strong>{{ $message }}</strong>
                                                  </span>
