...
<html lang="en">
  ...
  <body>
        ...
        <nav class="menu navbar">
          <div class="icon-list navbar-collapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('layout') }}">Shop</a>
              </li>                            
              <li class="nav-item">
    ...
    <header id="video-area" data-stellar-background-ratio="0.5">    
      <div id="block" data-vide-bg="{{ asset('video/video') }}"></div>
      <div class="fixed-top">
          <div class="container">
            <div class="logo-menu">
              <a href="index.html" class="logo"><span class="lnr lnr-diamond"></span> E-Laundry</a>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Sistem Informasi Manajemen E-Laundry</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Hightlight Produk + Laundry Services</p>
              <a href="#" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms"><i class="lnr lnr-download"></i> View Page</a>
            </div>
          </div>
        </div> 
      </div>      
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Some Fun Fact About<span>E-Laundry</span></h2>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="video-promo-content text-center">
                <div class="section-header">          
                  <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">E-Laundry <span></span></h2>
                  <hr class="lines wow zoomIn" data-wow-delay="0.3s">
                  <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Lacak Pesanan Mu Disini!</p>
                  <input type="text" class="form-control input-lg fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s" id="search_status" placeholder="Contoh : TR0392928" />
                  <button type="submit" class="btn btn-lg fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s" id="search-btn"><i class="fa fa-search"></i></button>
                </div>
                  {{-- <h2 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">E-Laundry</h2>
                  <p class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Lacak Pesanan Mu Disini</p> --}}
    ...
    <section id="portfolios" class="section">
      ...
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Our<span>Products</span></h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
    ...
    <div id="pricing" class="section pricing-section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Pricing <span>Products</span></h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy <br> nibh euismod tincidunt ut laoreet dolore magna.</p>
        </div>
    ...
    <div class="counters section" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Laundry <span>Categories</span></h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy <br> nibh euismod tincidunt ut laoreet dolore magna.</p>
        </div>
        <div class="row"> 
            ...
            <div class="wow fadeInUp" data-wow-delay=".8s">
              <div class="facts-item">
                ...
                <div class="fact-count">
                  ...
                  <h4>Washing, Drying and Ironing</h4>
                </div>
              </div>
            </div>
          </div>
    ...
    <div id="testimonial" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Kata Mereka Tentang <span>E-Laundry</span></h2>
        </div>
        <div class="row justify-content-md-center">
          <div class="col-md-10 wow fadeInRight" data-wow-delay="0.2s">
            <div class="touch-slider owl-carousel owl-theme">
              <div class="testimonial-item">
                <img src="\assets\img\testimonial\customer1.png" alt="Client Testimonoal" />
              ...
              <div class="testimonial-item">
                <img src="\assets\img\testimonial\customer2.png" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                  <h3>Oidila Matik</h3>
              ...
              <div class="testimonial-item">
                <img src="\assets\img\testimonial\customer3.png" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                  <h3>- Alex Dattilo</h3>
    ...
    <section id="download" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s"><span>Our</span>Clients</h2>
        </div>
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.6s">
              ...
              <div class="blog-item-text"> 
                <h3>
                  <a href="#">Begini Tanggapan Lesti</a>
                </h3>
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.9s">
              ...
              <div class="blog-item-text">    
                <h3>
                  <a href="#">Driver E-Laundry Termuda</a>
                </h3>
                <div class="meta-tags">
        ...
        <div class="row justify-content-md-center">          
          <div class="col-md-9 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">            
            <div class="contact-block">
              <div class="section-header">          
                <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Get In <span>Touch</span></h2>
                <hr class="lines wow zoomIn" data-wow-delay="0.3s">
              </div>
              <form id="contactForm">
                <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="site-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s">
              <p>All copyrights reserved &copy; 2022 - Designed & Developed by <a rel="nofollow" href="https://uideck.com">E-Laundry</a></p>
            </div>  
          </div>
        </div>
      </div>
